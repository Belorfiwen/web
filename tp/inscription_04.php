<?php
	...
	//affichage des erreurs eventuelles ou envoie dans la bd
	if (count($erreurs) == 0) {
		...
		echo 'Le nouvel utilisateur a bien &eacute;t&eacute; enregistré</br> Il a le num&eacute;ro ',$GLOBALS['utiID'];
	}
	else
	{
